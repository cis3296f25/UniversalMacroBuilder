 ...
 */
public class NewKeyReplayer {
    private static final Logger logger = LogManager.getLogger(NewKeyReplayer.class);
    ...
    /**
     * Constructor for {@link NewKeyReplayer}.
     ...
     */
    public NewKeyReplayer(LinkedHashMap<Long, String> loadedJNativeHookEvents) throws RuntimeException {
